...
import 'package:moni_test/pages/status/seller/input_items.dart';

class SellerConditions extends StatefulWidget {
  const SellerConditions({Key? key}) : super(key: key);

  @override
  _SellerConditionsState createState() => _SellerConditionsState();
}

class _SellerConditionsState extends State<SellerConditions> {
